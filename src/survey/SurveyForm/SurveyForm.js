...
const renderCurrentStep = () => {
  switch(currentStep) {
    ...
    case 7: // Surface ImageComparison B
      return <ImageComparison images={surfaceSelection.surfaceB} onSelectionComplete={onSelectionComplete} comparisonContext="surfaceBcompare" onComplete={() => setCurrentStep(8)} />;
    ...
    case 10: // Obstacle ImageComparison B
      return <ImageComparison images={obstacleSelection.obstacleB} onSelectionComplete={onSelectionComplete} comparisonContext="obstacleBcompare" onComplete={() => setCurrentStep(11)} />;
