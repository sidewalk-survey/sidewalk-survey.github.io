    ...
    return (
        <div className="question-container">
            <div className="image-comparison-content">
                <h2>{`${stepNumber}. When using your `}<strong>{mobilityAid}</strong>{`, which one do you feel more comfortable passing?`}</h2>
                <p className="text-instruction text-center mb-4 text-gray-600">If not comfortable in passing either, please select 'the same'.</p>
